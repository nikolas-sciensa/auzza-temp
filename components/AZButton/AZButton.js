function updateStyle(elem) {
    ...
    buttonIcon.src = 'auzza-temp/assets/images/arrow-right.png';
    buttonIcon.classList.add('buttonIcon');

    if (elem.hasAttribute('download')) {
        buttonIcon.src = 'auzza-temp/assets/images/download.png';
    }

    if (elem.hasAttribute('share')) {
        buttonIcon.src = 'auzza-temp/assets/images/share.png';
    }
    ...
    if (elem.hasAttribute('send')) {
        buttonIcon.src = 'auzza-temp/assets/images/send.png';
    }
